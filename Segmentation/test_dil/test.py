...
parser.add_argument('--experiment', default='test_dil', help='the path to store sampled images and models' )
parser.add_argument('--modelRoot', default='checkpoint_dil', help='the path to store the testing results')
