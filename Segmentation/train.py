...
parser.add_argument('--isDilation', action=False, help='whether to use dialated model or not' )
parser.add_argument('--isSpp', action=False, help='whether to do spatial pyramid or not' )
...
segLoader = DataLoader(segDataset, batch_size = opt.batchSize, num_workers = 16, shuffle = False )
...
for epoch in range(0, opt.nepoch):
    ...
    for i, dataBatch in enumerate(segLoader):
        ...
        print('Epoch %d iteration %d: Accumulated Accuracy %.5f' % ( epoch, iteration, meanAccuracy ) )
